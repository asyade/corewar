...
typedef	int32_t	(*t_f_interpret_token)(t_semantic_unit *
								, uint64_t, t_token *, t_bin_buffer *);
int32_t					ft_interpret_tokens(t_semantic_unit *unit,
							t_bin_buffer *bin);
int32_t					ft_interpret_param(t_semantic_unit *unit
								, uint64_t token_index
								, t_token *token, t_bin_buffer *bin);
int32_t					ft_interpret_content(t_semantic_unit *unit
							, uint64_t token_index
							, t_token *token, t_bin_buffer *bin);
int32_t					ft_interpret_comment(t_semantic_unit *unit
							, uint64_t token_index
							, t_token *token, t_bin_buffer *bin);
int32_t					ft_interpret_name(t_semantic_unit *unit
							, uint64_t token_index
							, t_token *token, t_bin_buffer *bin);
int32_t					ft_interpret_instruction(t_semantic_unit *unit
							, uint64_t token_index
							, t_token *token, t_bin_buffer *bin);
...
int32_t					ft_interpret_label(t_semantic_unit *unit
							, uint64_t token_index,
							t_token *token, t_bin_buffer *bin);
...
void					ft_fill_bin_with_instruction(t_semantic_unit *unit
									, uint64_t index
									, t_bin_buffer *bin);
uint8_t					ft_make_encoding_byte(t_arg_type *args
									, uint64_t nbr_args);
int32_t					ft_check_params_integrity(t_semantic_unit *unit
									, uint64_t index);

int32_t					ft_fill_header_name(t_semantic_unit *unit
									, t_bin_buffer *bin);
int32_t					ft_fill_header_comment(t_semantic_unit *unit
									, t_bin_buffer *bin);
